...
plt.ylabel('SIR-values [antal mennesker]')
plt.title('SIR')
plt.legend(loc='best')
plt.grid()
...
plt.plot(t, z[:, 1], 'g-', label='I')
plt.plot(t, z[:, 2], 'r-', label='R')
plt.ylabel('SIS-values [antal mennesker]')
plt.xlabel('tid [dage]')
plt.legend(loc='best')
plt.title('SIRS')
plt.grid()
...
plt.ylabel('SIQRS-values [antal mennesker]')
plt.legend(loc='best')
plt.title('SIQRS')
plt.grid()
...
plt.xlabel('time')
plt.ylabel('SIQRSV-values [antal mennesker]')
plt.xlabel('tid [dage]')
plt.legend(loc='best')
plt.title('SIQRSV')
plt.grid()
